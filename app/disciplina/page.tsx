          ...
          <main className="p-8 flex items-start justify-center overflow-y-auto max-h-[calc(100vh-4rem)]">
            <div className="w-full max-w-4xl bg-white p-8 rounded-xl shadow-md border border-slate-200 space-y-6 mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Disciplina 1 */}
                <div className="p-6 bg-slate-50 rounded-xl border border-slate-200 space-y-3 flex flex-col justify-between hover:shadow-sm transition-all">
                  <div className="space-y-2">
                    <span className="inline-block bg-blue-100 text-blue-700 text-xs font-bold px-2.5 py-1 rounded-md uppercase">Módulo Teórico/Prático</span>
                    ...
                    <div className="pt-2 text-xs text-slate-500">
                      <strong>Docente:</strong> Prof. Alberto
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 bg-slate-50 rounded-xl border border-slate-200 space-y-3 flex flex-col justify-between hover:shadow-sm transition-all">
                  <div className="space-y-2">
                    <span className="inline-block bg-emerald-100 text-emerald-700 text-xs font-bold px-2.5 py-1 rounded-md uppercase">Módulo Técnico</span>
                    <h3 className="font-extrabold text-xl text-slate-900">Programação Web I</h3>
                    <p className="text-sm text-slate-600 leading-relaxed">
                      Foco no desenvolvimento de aplicações para a internet. Compreende a estruturação de páginas web utilizando linguagens de marcação e estilização, lógica de programação client-side e construção de interfaces dinâmicas.
                    </p>
                    <div className="pt-2 text-xs text-slate-500">
                      <strong>Docente:</strong> Prof. Alberto
                    </div>
              ...
              <div className="p-4 bg-blue-50 border-l-4 border-blue-500 rounded-r-lg text-xs text-slate-700 mt-4">
                <strong>Nota de Integração:</strong> Ambos os componentes curriculares servem como alicerce fundamental para o desenvolvimento e compreensão do ecossistema deste projeto, unindo a infraestrutura de redes (TICS) com as interfaces de usuário (Web).
              </div>
            </div>
          </main>
        </div>
